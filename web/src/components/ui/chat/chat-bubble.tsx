...
const chatBubbleVariant = cva("flex gap-2 items-end relative group", {
  variants: {
    variant: {
      ...
      sent: "self-end flex-row-reverse max-w-[70%]",
    },
    layout: {
      default: "",
...
const chatBubbleMessageVariants = cva("", {
  variants: {
    variant: {
      received: "text-background-muted rounded-r-lg rounded-tl-lg",
      sent: "p-4 bg-muted text-white rounded-l-lg rounded-tr-lg",
    },
    layout: {
      default: "",
